...
easy, single-dataset protocol; cross-sensor and cross-session generalisation is expected to be
harder and remains future work.
...
\midrule
Cost scaling             & capped by CKKS slot packing & linear in $N$, no packing cap \\
